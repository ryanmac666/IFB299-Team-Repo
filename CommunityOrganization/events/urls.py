...
urlpatterns = [
    ...
    url(r'^(?P<event_id>[0-9]+)/attend:(?P<option>[0-9]+)/$', views.event_attend_view, name='event_attend_view'),
    url(r'^(?P<event_id>[0-9]+)/donate/$', views.event_donate_view, name='event_donate_view'),
    url(r'^(?P<event_id>[0-9]+)/volunteer:(?P<option>[0-9]+)/$', views.event_volunteer_view, name='event_volunteer_view'),
